...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item 규칙 $D$:
            \item \texttt{pi} $x_1$\texttt{\string\ }$D_2$는 머리가 $D_2$와 같은 규칙입니다.
            \item $A_r$은 머리가 $A_r$인 규칙입니다.
            \item $A_r$ \texttt{:-} $G$은 머리가 $A_r$인 규칙입니다.
            ...
            \begin{enumerate}
                ...
                \item 그러나, 그 시도가 성공하면, $p \, t_1 \, \cdots \, t_n$이 증명된 것으로 봅니다.
            \end{enumerate}
        \end{itemize}
    \end{frame}
